...
const here = require('../model/access.model');

// Get all
router.get('/', async (req, res) => { here.read(res); });

router.get('/byrol/:param', async (req, res) => {
    const { param } = req.params;
    here.getRolAccess(param, res);
});
...
router.patch('/tiendaCompartida/:param', async (req, res) => {
    const { param } = req.params;
    here.accesTiendaCompartida(res, req.body)
